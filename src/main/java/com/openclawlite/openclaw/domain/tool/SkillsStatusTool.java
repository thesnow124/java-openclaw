...
import com.openclawlite.openclaw.domain.agent.SkillRef;
import com.openclawlite.openclaw.domain.agent.SkillSnapshot;
        ...
        try {
            ...
            if (snapshot == null || snapshot.getSkills() == null || snapshot.getSkills().isEmpty()) {
                ...
                for (SkillRef skill : skills) {
                    ...
                    if (skill.getLocation() != null && !skill.getLocation().isEmpty()) {
                        response.append("  位置: ").append(skill.getLocation()).append("\n");
                    }
